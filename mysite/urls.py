...
urlpatterns = [
    ...
    path('google/callback/extension', views.extension_google_login_callback, name='extension_google_callback_direct'),
    path('login/google/',views.google_login_redirect, name='google_login'),
    path('login/google/extension',views.extension_google_login_redirect, name='extension_google_login'),
    path('login/callback/', views.google_login_callback, name='google_callback'),
    path('login/callback/extension', views.extension_google_login_callback, name='extension_google_callback'),
    path('output/',views.output_page,name="output"),
    path('trending/',views.trending, name='trending'),
    path('term/', views.term, name='term'),  
    path('feedback_extension/', views.feedback_extension, name='term'),        
]